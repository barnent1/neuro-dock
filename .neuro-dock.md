...
3. **Context Acknowledgment**: Confirm you've read this entire `.neuro-dock.md` manual
4. **Begin Engagement**: Start the Project Discovery Conversation (see Phase 1 below)
...
1. **Facilitate deep project discussions** with the human before any technical work
2. **Orchestrate NeuroDock commands** with properly piped information
3. **Maintain project context** and ensure continuity across all phases
4. **Guide the human** through proven agile development methodology
5. **Make intelligent decisions** about when to proceed vs. gather more information

### Command Execution Authority
You have full authority to run NeuroDock commands. Use this pattern:
```bash
echo "project information gathered from conversation" | nd [command]
```
