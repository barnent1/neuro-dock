...
- **Agent Orchestration**: AI Agent 1 uses NeuroDock commands to orchestrate project development
- **Task Execution**: AI Agent 2 (LLM backend) executes individual development tasks
...
### Overview
Agent 1 serves as your intelligent development partner, facilitating comprehensive conversations throughout the entire project lifecycle. Agent 1 acts as the interface between you (the developer) and the system, ensuring context clarity and memory preservation.

### Agent 1 Conversational Capabilities
...
- Relays Agent 2's clarifying questions to developer
- Feeds developer answers back to Agent 2
...
- Coordinates with Agent 2 for technical execution
...
- Provides Agent 2 reminders for better assistance

### Conversational Flow Example

```
Developer: "Agent 1, read .neuro-dock.md and let's start a new project"

Agent 1: "I've read the documentation and understand our system. I'm Agent 1, 
your development partner who will guide you through the complete Agile process. 
I work with Agent 2 (our memory and technical agent) to ensure nothing is lost 
...
Agent 1: "Excellent! Let me engage our discuss system to gather detailed 
requirements. I'll relay any questions from Agent 2 to you and ensure 
your answers are properly stored in our memory system..."

[Agent 1 runs nd discuss internally]
[Agent 2 generates questions]

Agent 1: "Agent 2 has identified some key areas that need clarification:
1. [Question 1]
2. [Question 2]
3. [Question 3]
...
Agent 1: "Perfect! I'm storing your answers in our memory system and 
...
- Agent 1 learns from conversation patterns
...
nd explain [topic]          # Agent 1 explains any system aspect
